                ...
                <div className="damage-dealer">
                    ...
                    <div className="damage-dealer-grid">
                        ...
                        <div className="splus-row tierlist-row">
                            ...
                            {SyncPairIcon("Lear & Hoopa (Confined)", "lear-trainer psychic pasio rival sunglasses tech exr-strike pokefair has-lodge", "/images/pair/00_PASIO/00_PASIO_0E-01_Lear.png", "orange")}
                        ...
                        <div className="aminus-row tierlist-row">
                            ...
                            {SyncPairIcon("Player & Solgaleo", "player-trainer steel main-character pasio strike exr-none legendary-adventure", "/images/pair/00_PASIO/00_PASIO_0Cb_Solgaleo.png", "yellow")}
                        ...
                        <div className="bplus-row tierlist-row">
                            ...
                            {SyncPairIcon("Lear & Krookodile", "lear-trainer dark pasio rival sunglasses tech exr-none lodge-pair lodge-gacha", "/images/pair/00_PASIO/Lear_0553.png", "green")}
                ...
                <div className="hybrid">
                    ...
                    <div className="hybrid-grid">
                        <div className="uber-row tierlist-row">
                            ...
                            {SyncPairIcon("Sygna Suit Lear & Gholdengo", "lear-trainer steel pasio rival sygna-suit sunglasses sprint exr-strike master-fair", "/images/pair/00_PASIO/Lear_Gholdengo_5.png", "yellow")}
                        ...
                        <div className="aplus-row tierlist-row">
                            ...
                            {SyncPairIcon("Paulo & Lycanroc Dusk", "paulo-trainer rock rival knowledgeable pasio sprint exr-support pokefair", "/images/pair/00_PASIO/00_PASIO_0E-04_Paulo.png", "yellow")}
                        ...
                        <div className="dminus-row tierlist-row">
                            ...
                            {SyncPairIcon("Player & Pikachu", "player-trainer electric main-character pasio strike exr-none story", "/images/pair/00_PASIO/00_PASIO_0A-01b_Pikachu.png", "yellow")}
                ...
                <div className="utility">
                    ...
                    <div className="utility-grid">
                        ...
                        <div className="aplus-row tierlist-row">
                            ...
                            {SyncPairIcon("Sawyer & Gimmighoul", "sawyer-trainer ghost sunglasses body-builder pasio support exr-sprint variety", "/images/pair/00_PASIO/Sawyer_Gimmighoul_5.png", "yellow")}
                        ...
                        <div className="bplus-row tierlist-row">
                            <div className="tier-title">B+</div>
                            {SyncPairIcon("Tina & Flareon", "tina-trainer fire free-spirit passionate-spirit pasio support exr-none pokefair", "/images/pair/00_PASIO/00_PASIO_0E-05_Tina.png", "red")}
                            ...
                            {SyncPairIcon("Player & Mesprit", "player-trainer psychic main-character pasio support exr-none battle-point", "/images/pair/00_PASIO/00_PASIO_0Db_Mesprit.png", "yellow")}
                            {SyncPairIcon("Player & Cobalion", "player-trainer fighting main-character pasio support exr-none battle-point", "/images/pair/00_PASIO/00_PASIO_0Db_Cobalion.png", "yellow")}
                        ...
                        <div className="b-row tierlist-row">
                            ...
                            {SyncPairIcon("Rachel & Gimmighoul", "rachel-trainer ghost pasio sunglasses free-spirit support exr-sprint variety", "/images/pair/00_PASIO/Rachel_Gimmighoul_5.png", "red")}
                        ...
                        <div className="bminus-row tierlist-row">
                            ...
                            {SyncPairIcon("Player & Raikou", "player-trainer electric main-character pasio support exr-none battle-point", "/images/pair/00_PASIO/PlayerM_Raikou_5.png", "orange")}
                            ...
                            {SyncPairIcon("Sawyer & Honchkrow", "sawyer-trainer dark sunglasses body-builder pasio support exr-none pokefair", "/images/pair/00_PASIO/Sawyer_Honchkrow_4.png", "yellow")}
                            ...
                            {SyncPairIcon("Player & Alcremie", "player-trainer fairy main-character pasio support exr-none event", "/images/pair/00_PASIO/Scottie_Alcreamie_4.png", "green")}
                        </div>
                        <div className="cplus-row tierlist-row">
                            <div className="tier-title">C+</div>
                            ...
                            {SyncPairIcon("Player & Registeel", "player-trainer steel main-character pasio support exr-none battle-point", "/images/pair/00_PASIO/00_PASIO_0Db_Registeel.png", "yellow")}
                        ...
                        <div className="c-row tierlist-row">
                            ...
                            {SyncPairIcon("Player & Regirock", "player-trainer rock main-character pasio support exr-none battle-point", "/images/pair/00_PASIO/00_PASIO_0Db_Regirock.png", "yellow")}
                        ...
                        <div className="dplus-row tierlist-row">
                            ...
                            {SyncPairIcon("Rachel & Umbreon", "rachel-trainer dark pasio sunglasses free-spirit support exr-none pokefair", "/images/pair/00_PASIO/Rachel_Umbreon_4.png", "red")}
                            ...
                            {SyncPairIcon("Player & Torchic", "player-trainer fire main-character pasio support exr-none story", "/images/pair/00_PASIO/00_PASIO_0B-01b_Torchic.png", "orange")}
